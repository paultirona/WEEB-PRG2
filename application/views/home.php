            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href='<?php echo base_url()."index.php/account/Shop"?>' class="btn btn-info">Search</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href='<?php echo base_url()."index.php/account/contact"?>' class="btn btn-info">Contact</a>
                    </div>
                </div>
            </div>
        </div>
